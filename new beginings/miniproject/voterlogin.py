...
class VoterLogin:
    def __init__(self, master):
        ...
        self.entry_email = ctk.CTkEntry(self.root, font=("Helvetica", 12), bg_color="black")
    ...
    def submit_form(self):
        ...
        if not pid or not roll:
            messagebox.showerror("Error", "Please enter both PID and roll.")
            return
        ...
        if voter:
            ...
            messagebox.showerror("Error", "Invalid PID or roll.")
